...
| 登录页 | 任务列表 |
| :---: | :---: |
| ![登录页](docs/screenshot-login.png) | ![任务列表](docs/screenshot-tasks.png) |

| 数据概览 | 深色模式 |
| :---: | :---: |
| ![数据概览](docs/screenshot-dashboard.png) | ![深色模式](docs/screenshot-dark.png) |

> 截图放置于仓库 `docs/` 目录,命名约定见 [docs/README.md](docs/README.md)。
